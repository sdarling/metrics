...
Metric.create("name" => "Access Control", "csf_function_id" => 2, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
...
Metric.create("name" => "Cyber Resource Recovery", "csf_function_id" => 5, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Data Security", "csf_function_id" => 1, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Incident Containment", "csf_function_id" => 4, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 3)
...
Metric.create("name" => "Mobile Device Security", "csf_function_id" => 2, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Penetration Testing", "csf_function_id" => 3, "unit_id" => 3, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Policy Compliance", "csf_function_id" => 3, "unit_id" => 3, "recent_maturity_level" => 0, "target_maturity_level" => 3)
...
Metric.create("name" => "System Patching", "csf_function_id" => 2, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 3)
