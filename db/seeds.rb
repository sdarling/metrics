...
Metric.create("name" => "Access Control", "csf_function_id" => 2, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 2)
Metric.create("name" => "AV/Malware Protection", "csf_function_id" => 2, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Configuration Baseline","csf_function_id" => 2, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Cyber Resource Recovery", "csf_function_id" => 5, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 2)
Metric.create("name" => "Data Security", "csf_function_id" => 1, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 2)
Metric.create("name" => "Incident Containment", "csf_function_id" => 4, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 2)
Metric.create("name" => "Incident Detection", "csf_function_id" => 3, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Incident Response", "csf_function_id" => 4, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Mobile Device Mgmt.", "csf_function_id" => 1, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Mobile Device Security", "csf_function_id" => 2, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 2)
Metric.create("name" => "Penetration Testing", "csf_function_id" => 3, "unit_id" => 3, "recent_maturity_level" => 0, "target_maturity_level" => 2)
Metric.create("name" => "Policy Compliance", "csf_function_id" => 3, "unit_id" => 3, "recent_maturity_level" => 0, "target_maturity_level" => 2)
Metric.create("name" => "Policy Violation Reporting", "csf_function_id" => 4, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Recovery Time Objectives", "csf_function_id" => 5, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Regulatory Compliance", "csf_function_id" => 1, "unit_id" => 3, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Risk Mitigation", "csf_function_id" => 3, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Risk Register", "csf_function_id" => 4, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "Subcontractor Security", "csf_function_id" => 1, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
Metric.create("name" => "System Patching", "csf_function_id" => 2, "unit_id" => 2, "recent_maturity_level" => 0, "target_maturity_level" => 2)
Metric.create("name" => "Training and Awareness", "csf_function_id" => 2, "unit_id" => 1, "recent_maturity_level" => 0, "target_maturity_level" => 3)
