...
class MetricsControllerTest < ActionController::TestCase
  ...
  test "should create metric" do
    assert_difference('Metric.count') do
      post :create, metric: { month_id: @metric.month_id, name: @metric.name, organization_id: @metric.organization_id, year: @metric.year }
    end
  ...
  test "should update metric" do
    patch :update, id: @metric, metric: { month_id: @metric.month_id, name: @metric.name, organization_id: @metric.organization_id, year: @metric.year }
    assert_redirected_to metric_path(assigns(:metric))
  end
